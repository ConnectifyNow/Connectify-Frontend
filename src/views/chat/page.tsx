...
import ConversationList from "@/components/chat/conversation-list/conversation-list";
...
import StartConversationDialog from "@/components/chat/start-conversation-dialog/StartConversationDialog";
import ConversationChat from "@/components/chat/conversationChat/ConversationChat";

const GET_CONVERSATIONS = 'conversations';
                    ...
                    if (conversation) {
                        ...
                        if (conversationLead) {
                            const newMessages: Message[] = [
                                ...
                                { _id: messageId, content, createdAt: new Date(), sender: conversationLead },
                            ];
