        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <button className="bg-black hover:bg-blue-300 text-white font-bold py-2 px-4 rounded hover:scale-105 focus:outline-none focus:ring-2 focus:ring-gray-500 ">
